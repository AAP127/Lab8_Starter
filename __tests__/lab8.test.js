...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let buttonTxt = elemButton.innerText;    
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    for (let item of prodItems){
      ...
      let itemButton =  item.shadowRoot.querySelector("button");
      await page.click(itemButton);
    }
    
    
    // Check to see if the innerText of #cart-count is 20
    let cartCountNum = document.getElementById("cart-count").innerText;
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let item of prodItems){
      ...
      let itemButton =  item.shadowRoot.querySelector("button");
      expect(itemButton.innerText).toBe("Remove from Cart");
    }
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let item of prodItems){
      ...
      let itemButton =  item.shadowRoot.querySelector("button");
      expect(itemButton.innerText).toBe("Add to Cart");
    }
